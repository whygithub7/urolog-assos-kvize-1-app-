// Массивы с контентом
        const landingContent = {
            ...
            orderButtonText: "Заказать прямо сейчас",
            paragraphs: [
            ...
            socialProof: [
                ...
                // "80% мужчин в нашей стране старше 35 лет страдают от скрытых нарушений половой функции.",
...
const results = {
    ...
    sections: [
        ...
        summary: "В основе препарата Formelan лежат 3 главных компонента - гуарана, женьшень и L-аргинин. Их действие усилено дополнительными натуральными веществами. Сочетание компонентов восстановливает простату и улучшает половые функции. При этом препарат безопасен даже в 60 лет и не вызывает привыкания."
    },
    orderForm: {
    ...
    bottomOrderButton: "Заказать со скидкой"
};
