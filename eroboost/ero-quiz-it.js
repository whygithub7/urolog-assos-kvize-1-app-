const landingContent = {
    ...
    orderButtonText: "Ordina Eroboost ora",
    paragraphs: [
    ...
    slides2: [
        {
            img: "dp/1.webp", 
            text: "Ho 60 anni, e Eroboost mi ha riportato alla vita. Ora ho una erezione stabile e sesso 40-60 minuti. Prima non credo ai risultati del test, ma ho preso il rischio e non l'ho pentito!"
        },
        {
            img: "dp/2.webp", 
            text: "Sono un ingegnere e passo molto tempo davanti al computer. Ho 53 anni. Eroboost mi ha aiutato a gestire i problemi di potenza causati dal modo di vivere sedentario."
        },
        {
            img: "dp/3.webp", 
            text: "Ho preso Viagra per 1 mese, poi è successo un infarto. I medici mi hanno consigliato Eroboost come sostituzione naturale. Funziona più velocemente delle pillole e non danneggia gli organi interni."
        },
        {
            img: "dp/4.webp",
        ...
        {
            img: "dp/8.webp",
            text: "Ho 58 anni e lavoro in fabbrica. A causa del lavoro fisico pesante e dello stress costante, sono iniziati i problemi di erezione. Eroboost ha ripristinato la potenza."
        },
        {
            img: "dp/9.webp",
            text: "Ho 42 anni. Io e mia moglie avevamo già un sesso stabile prima di queste capsule. Ho iniziato a usare Eroboost per prevenire la prostatite e l'impotenza. Dopo 1 ciclo, il mio pene è diventato molto più forte ed è diventato più lungo e voluminoso."
        },
        {
            img: "dp/10.webp",
            text: "Sono un ex sollevatore di pesi. Gli allenatori mi riempivano di preparati per la crescita muscolare. Hanno distrutto la mia potenza. Gli ultimi 5 anni ho passato 3 giorni a settimana in ospedale. I medici non hanno aiutato. Eroboost è diventato il mio salvagente."
        }
    ], 
    footerText:[
...
items: [
    {
        ...
        answer: {
            intro: "L'effetto di Eroboost ha due fasi:",
            list: [
    ...
    {
        question: "Eroboost è adatto per uomini sopra i 60 anni?",
        answer: {
            intro: "Eroboost è particolarmente efficace per uomini sopra i 60 anni, poiché tiene conto di tutte le modifiche dell'organismo:",
            list: [
            ...
            conclusion: "L'accumulo graduale dell'effetto e la composizione naturale rendono Eroboost la migliore scelta per uomini sopra i 60 anni. Il farmaco non richiede una dieta speciale, è sicuro per il sistema cardiovascolare e aiuta a mantenere l'erezione e la prostata sana in ogni età."
        }
    },
    {
        question: "C'è qualche controindicazione?",
        answer: {
            intro: "Sì, le capsule non possono essere utilizzate se hai:",
            list: [
            ...
            conclusion: "Se hai allergia a qualsiasi componente, dovresti evitare di utilizzare. In tutti gli altri casi, le capsule sono completamente sicure e non richiedono consultazione medica."
        }
    },
    {
    ...
    {
        question: "Come utilizzare correttamente Eroboost?",
        answer: {
            intro: "Eroboost è facile da usare, ma ci sono due modi di usarlo:",
            list: [
                "Per effetto rapido: prendere 1 capsula 30-40 minuti prima del rapporto",
                "Per effetto terapeutico: prendere 1 capsula 2 volte al giorno - mattino e sera",
                "Le capsule vanno assunte con acqua",
                "Per un migliore effetto, prendere le capsule dopo i pasti"
            ],
            conclusion: "Dopo aver effettuato l'ordine, uno specialista ti chiamerà e spiegherà in dettaglio come utilizzare Eroboost per un effetto rapido e un trattamento a lungo termine nel tuo caso specifico."
        }
    }
]
},
...
whatToDoText: [
"Sulla base dei risultati del tuo test, abbiamo determinato che ti serve un intervento complessivo sulla prostata e il sistema circolatorio della zona pelvica. Eroboost contiene esattamente i componenti che ti servono per eliminare i problemi rilevati.",
"Eroboost è stato progettato specificamente per casi come il tuo, dove è presente una combinazione di prostatite e disfunzione erettile. I componenti attivi del farmaco iniziano a agire già nel primo giorno di assunzione: riducono l'infiammazione, migliorano la circolazione sanguigna e ripristinano le funzioni della prostata.",
"Come paziente dell'associazione urologica, puoi ottenere Eroboost con uno sconto del 50%. Considerando il carattere progressivo della malattia, ti consigliamo di iniziare a prendere il farmaco il più presto possibile."
],
